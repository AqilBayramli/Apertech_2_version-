...
const translations = {
    en: {
        ...
        "solution-detail.journey.rollout.desc": "Optimization Program",
        "solution-detail.status.eyebrow": "What you get",
        "solution-detail.status.item1": "A success team composed of industry-specialized experts.",
        "solution-detail.status.item2": "Pre-built reporting packages for executive leadership.",
        "solution-detail.status.item3": "Scalable, governed operations",
    ...
    az: {
        ...
        "about.content1": "Apertech Solutions, hər ölçüdə təşkilatlara yenilikçi və təsirli ERP həlləri təqdim etməkdə ixtisaslaşmış Azərbaycanın Bakı şəhərində yerləşən bir texnoloji və iş konsaltinq şirkətidir. Yarandığı gündən bəri Apertech, şirkətlərə iş proseslərini asanlaşdırmağa, qərar qəbul etmə prosesini yaxşılaşdırmağa və etibarlı, genişlənə bilən və özelleştirilebilir proqram sistemləri ilə rəqəmsal çevrilməyə nail olmağa kömək etməyə yönəlmişdir.",
        "about.content2": "Biz Müəssisə Resurslarının Planlaşdırılması (ERP), maliyyə menecmenti, biznes analitikası və xüsusi proqram təminatı üzrə ixtisaslaşmışıq. Infor SunSystems-in rəsmi regional tərəfdaşı olaraq, biz bütün dünyada müəssisələrin etibar etdiyi dünya səviyyəli maliyyə və mühasibat həlləri təqdim edirik. Bundan əlavə, öz Genesis məhsulumuz, şirkətlərin fəaliyyətlərinə tam nəzarət etmələrinə kömək edərək, satınalma idarəetməsi, büdcə, müqavilə izləmə və məlumatların təhlili üçün qabaqcıl vasitələr təklif edir.",
        "about.content3": "Apertech - də hər bir təşkilatın texnoloji ehtiyacları kimi unikal olduğuna inanırıq.",
        "about.experience": "Təcrübə",
        "about.experience_desc": "20-dən çox proqram təminatı ekspertindən ibarət böyük komandamız var.",
        ...
        "solution-detail.journey.rollout.desc": "Optimallaşdırma proqramı",
        "solution-detail.status.eyebrow": "Nə əldə edirsiniz",
        "solution-detail.status.item1": "Sahə üzrə ixtisaslaşmış ekspertlərdən ibarət komanda",
        "solution-detail.status.item2": "Rəhbərlərə hazır hesabatlar.",
        "solution-detail.status.item3": "Miqyaslana bilən və idarə olunan əməliyyatlar.",
    ...
    ru: {
        ...
        "about.content1": "Apertech Solutions - это технологическая и бизнес-консалтинговая компания, базирующаяся в Баку, Азербайджан, специализирующаяся на предоставлении инновационных и эффективных Erp-решений организациям любого размера. С момента своего основания Apertech сосредоточилась на оказании помощи компаниям в оптимизации их бизнес-процессов, улучшении процесса принятия решений и достижении цифровой трансформации с помощью надежных, масштабируемых и настраиваемых программных систем.",
        "about.content2": "Мы специализируемся на планировании ресурсов предприятия (ERP), финансовом менеджменте, бизнес-аналитике и разработке программного обеспечения на заказ. Являясь официальным региональным партнером Infor SunSystems, мы предоставляем финансовые и бухгалтерские решения мирового класса, которым доверяют предприятия по всему миру. Кроме того, наш собственный продукт Genesis предлагает передовые инструменты для управления закупками, составления бюджета, отслеживания контрактов и анализа данных, помогая компаниям сохранять полный контроль над своей деятельностью.",
        "about.content3": "В Apertech мы считаем, что каждая организация уникальна, как и ее технологические потребности.",
        "about.experience": "Опыт",
        "about.experience_desc": "Наша команда состоит из более чем 20 экспертов по программному обеспечению.",
        ...
        "solution-detail.journey.rollout.desc": "Программа оптимизации",
        "solution-detail.status.eyebrow": "Что вы получаете",
        "solution-detail.status.item1": "Успешная команда, состоящая из отраслевых экспертов.",
        "solution-detail.status.item2": "Отчёты, готовые для руководства.",
        "solution-detail.status.item3": "Масштабируемые и управляемые процессы.",
